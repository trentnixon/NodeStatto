...
export default class Home_Overview extends Component {
    componentWillMount() { 
        //console.log(this.props.DATA, this.props.DATA.CAREER.Batting.ballsFaced)
         stones=[
            { var:this.props.DATA.CAREER.Batting.innings,     Path:"batting/overview", label:this.props.SUBS.INNINGS,icon:<Trophy/>},
            ...
            { var:this.props.DATA.CAREER.Batting.ballsFaced,     Path:"batting/by-the-ball", label:this.props.SUBS.BF,icon:<Bowling/>},
            { var:this.props.DATA.CAREER.Batting.s_50,     Path:"batting/scores", label:this.props.SUBS.FIFTY,icon:<StarsIcon />},
            { var:this.props.DATA.CAREER.Batting.ducks,     Path:"batting/scores", label:this.props.SUBS.DUCKS,icon:<Duck/>},
        ]  
     }  
    render() { 
