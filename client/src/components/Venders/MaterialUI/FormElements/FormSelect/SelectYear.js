...
// Action 
import {Form_Select_Year} from "../../../../../actions/UI/UI";
import {GA_Form_Select_Year} from "../../../../../actions/UI/ga";
                            ...
                            <FormControl variant="outlined" className="YearSelector" >
                                ...
                                <InputLabel ref={ref => { this.InputLabelRef = ref; }} htmlFor="outlined-year-simple"> 
                                    ...
                                    >
                                            ...
                                            {
                                                this.props.DATA.SelectedPlayer.Primary.CAREER.Batting.overTheYears.map((year,i)=>{
                                                    return(
